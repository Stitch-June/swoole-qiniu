<?php
namespace Gaobinzhan\Processing;
...
final class ImageUrlBuilder
{
    ...
    public function waterImg(
        ...
        $waterStr = 'watermark/1/image/' . \Gaobinzhan\base64_urlSafeEncode($image) . '/';
    ...
    public function waterText(
        ...
        $waterStr = 'watermark/2/text/'
            . \Gaobinzhan\base64_urlSafeEncode($text) . '/font/'
            . \Gaobinzhan\base64_urlSafeEncode($font) . '/';
        ...
        if (!is_null($fontColor)
            ...
            $waterStr .= 'fill/' . \Gaobinzhan\base64_urlSafeEncode($fontColor) . '/';
        }
